...
use codex_tui_bottom_pane::SelectionAction;
use codex_tui_bottom_pane::SelectionItem;
use codex_tui_bottom_pane::SelectionViewParams;
use codex_tui_bottom_pane::SideContentWidth;
use codex_tui_bottom_pane::popup_consts::standard_popup_hint_line;
use codex_tui_events::AppEvent;
use codex_tui_pet::DEFAULT_PET_ID;
use codex_tui_pet::DISABLED_PET_ID;
use codex_tui_pet::catalog;
use codex_tui_pet::model::CUSTOM_PET_PREFIX;
use codex_tui_pet::model::Pet;
use codex_tui_pet::model::custom_pet_selector;

pub const PET_PICKER_VIEW_ID: &str = "pet-picker";
...
pub fn build_pet_picker_params(
    ...
    let preview_pet_ids = entries
        ...
        .collect::<Vec<_>>();
    let on_selection_changed: codex_tui_bottom_pane::OnSelectionChangedCallback = Some(Box::new(
        move |idx: usize, tx: &codex_tui_events::AppEventSender| {
