...
use codex_core_mcp_runtime::McpManager;
use codex_core_plugin_context::list_tool_suggest_discoverable_plugins;
...
const CONNECTOR_DISCOVERY_SUBMIT_ID: &str = "";
...
pub async fn list_accessible_connectors_from_mcp_tools_with_mcp_manager(
    ...
    let mcp_connection_manager = McpConnectionManager::new(
        ...
        CONNECTOR_DISCOVERY_SUBMIT_ID.to_owned(),
        /*tx_event*/ None,
        cancel_token.clone(),
