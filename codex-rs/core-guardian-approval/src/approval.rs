//! Guardian approval requests and model-review projections.
...
/// Structured output returned by a Guardian reviewer session.
...
/// Tracks repeated Guardian denials within each active turn.
...
/// Outcome of recording one Guardian review decision for a turn.
...
pub enum GuardianApprovalRequest {
    Shell {
        ...
        command: Vec<String>,
        cwd: AbsolutePathBuf,
        sandbox_permissions: codex_core_exec::sandboxing::SandboxPermissions,
...
pub struct GuardianNetworkAccessTrigger {
    ...
    pub sandbox_permissions: codex_core_exec::sandboxing::SandboxPermissions,
