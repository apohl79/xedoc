...
mod markdown {
    pub use codex_tui_transcript::markdown::*;
}
...
mod session_resume {
    ...
    pub async fn resolve_session_thread_id(
        ...
        match id_str_if_uuid {
            ...
            None => codex_rollout::read_session_meta_line(path)
                .await
                .ok()
...
mod thread_transcript {
    use codex_protocol::ThreadId;
    use codex_tui_app_server_session::AppServerSession;

    pub use codex_tui_transcript::thread_transcript::RawReasoningVisibility;
    pub use codex_tui_transcript::thread_transcript::TranscriptCells;
    pub use codex_tui_transcript::thread_transcript::thread_to_transcript_cells;
