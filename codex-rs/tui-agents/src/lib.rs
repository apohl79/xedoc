...
use codex_tui_render::render::line_utils::prefix_lines;
use codex_tui_transcript::history_cell::PlainHistoryCell;
use codex_tui_transcript::text_formatting::truncate_text;
...
pub fn previous_agent_shortcut() -> codex_tui_input::key_hint::KeyBinding {
    codex_tui_input::key_hint::alt(KeyCode::Left)
}

pub fn next_agent_shortcut() -> codex_tui_input::key_hint::KeyBinding {
    codex_tui_input::key_hint::alt(KeyCode::Right)
}
