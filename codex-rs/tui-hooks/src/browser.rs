...
use codex_tui_events::AppEvent;
use codex_tui_events::AppEventSender;
use codex_tui_events::HookTrustUpdate;
use codex_tui_input::key_hint;
use codex_tui_input::key_hint::KeyBindingListExt;
use codex_tui_input::keymap::ListKeymap;
use codex_tui_overlays::bottom_pane::CancellationEvent;
use codex_tui_overlays::bottom_pane::bottom_pane_view::BottomPaneView;
use codex_tui_overlays::bottom_pane::popup_consts::MAX_POPUP_ROWS;
use codex_tui_overlays::bottom_pane::scroll_state::ScrollState;
use codex_tui_overlays::bottom_pane::selection_popup_common::render_menu_surface;
use codex_tui_render::city_lights::CityLightsStylize;
use codex_tui_render::render::renderable::Renderable;
use codex_tui_render::style::accent_style;
use codex_tui_status::status::format_directory_display;
use codex_tui_transcript::line_truncation::truncate_line_with_ellipsis_if_overflow;
...
impl HooksBrowserView {
    ...
    pub(crate) fn new(
        ...
        Self::from_entry(
            ...
            app_event_tx,
            codex_tui_input::keymap::RuntimeKeymap::defaults().list,
        )
    }
...
mod tests {
    ...
    use codex_tui_overlays::bottom_pane::bottom_pane_view::BottomPaneView;
    use codex_tui_render::render::renderable::Renderable;
    use codex_tui_test_support::PathBufExt;
    use codex_tui_test_support::test_path_buf;
    use codex_tui_test_support::test_path_display;
    use crossterm::event::KeyCode;
    use crossterm::event::KeyEvent;
