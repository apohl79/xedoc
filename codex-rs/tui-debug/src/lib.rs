...
use codex_core_config::config::Permissions;
use codex_protocol::models::PermissionProfile;
use codex_protocol::permissions::NetworkSandboxPolicy;
use codex_tui_render::city_lights::CityLightsStylize;
use codex_tui_transcript::history_cell::PlainHistoryCell;
use codex_tui_transcript::session_state::SessionNetworkProxyRuntime;
    ...
    if let Some(proxy) = session_network_proxy {
        ...
        let all_proxy = session_all_proxy_url(
            ...
            config
                ...
                .network
                .as_ref()
                .is_some_and(codex_core_config::config::NetworkProxySpec::socks_enabled),
        );
