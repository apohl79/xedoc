...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum AppLinkSuggestionType {
    Install,
    Enable,
    Auth,
    ExternalAction,
...
pub struct AppLinkElicitationTarget {
...
pub struct AppLinkViewParams {
    ...
    pub suggestion_type: Option<AppLinkSuggestionType>,
    pub elicitation_target: Option<AppLinkElicitationTarget>,
}

impl AppLinkViewParams {
    pub fn from_url_app_server_request(
        thread_id: ThreadId,
        server_name: &str,
...
impl AppLinkView {
    #[cfg(test)]
    pub fn new(params: AppLinkViewParams, app_event_tx: AppEventSender) -> Self {
                ...
                (0..area.width)
                    .map(|x| {
                        ...
                        if symbol.is_empty() {
                            ...
                            strip_osc8_for_snapshot(symbol)
                                .chars()
                                .next()
                                .unwrap_or(' ')
                        }
