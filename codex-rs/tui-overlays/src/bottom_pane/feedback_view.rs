...
pub fn should_show_feedback_connectivity_details(
    category: FeedbackCategory,
...
pub fn feedback_classification(category: FeedbackCategory) -> &'static str {
    match category {
...
pub fn feedback_selection_params(app_event_tx: AppEventSender) -> super::SelectionViewParams {
...
pub fn feedback_disabled_params() -> super::SelectionViewParams {
    super::SelectionViewParams {
