...
pub const EFFORT_STATUS_LINE_FRAME_TICK: Duration = Duration::from_millis(33);
...
pub struct EffortStatusLineTransition {
    tier: EffortTier,
...
impl EffortStatusLineTransition {
    pub fn new(tier: EffortTier, previous: Line<'static>) -> Self {
        Self {
            tier,
            previous,
