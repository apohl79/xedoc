...
pub use ambient::AmbientPet;
pub use ambient::AmbientPetDraw;
pub use ambient::PetNotificationKind;
pub use ambient::test_ambient_pet;
pub use asset_pack::builtin_spritesheet_path;
pub use asset_pack::write_test_pack;
pub use image_protocol::ImageProtocol;
pub use image_protocol::PetImageSupport;
pub use image_protocol::PetImageUnsupportedReason;
pub use image_protocol::detect_pet_image_support;
...
pub fn ensure_builtin_pack_for_pet(pet_id: &str, codex_home: &std::path::Path) -> Result<()> {
...
pub fn render_ambient_pet_image(
...
pub fn render_pet_picker_preview_image(
    writer: &mut impl Write,
    state: &mut PetImageRenderState,
    request: Option<AmbientPetDraw>,
) -> std::result::Result<(), PetImageRenderError> {
