...
impl ChatWidget {
    ...
    pub fn seed_status_line_command_output_from(&mut self, previous: &ChatWidget) {
    ...
    pub fn preview_terminal_title(&mut self, items: Vec<TerminalTitleItem>) {
    ...
    pub fn revert_terminal_title_setup_preview(&mut self) {
    ...
    pub fn cancel_terminal_title_setup(&mut self) {
    ...
    pub fn setup_terminal_title(&mut self, items: Vec<TerminalTitleItem>) {
    ...
    pub fn set_status_line_git_summary(&mut self, cwd: PathBuf, summary: StatusLineGitSummary) {
    ...
    pub fn add_status_output(&mut self, refreshing_rate_limits: bool, request_id: Option<u64>) {
    ...
    pub fn finish_status_rate_limit_refresh(
        &mut self,
        request_id: u64,
