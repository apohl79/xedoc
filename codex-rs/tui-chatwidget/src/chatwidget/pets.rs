...
impl ChatWidget {
    ...
    pub fn ambient_pet_image_enabled(&self) -> bool {
        self.ambient_pet
            .as_ref()
            .is_some_and(crate::pets::AmbientPet::image_enabled)
    }

    pub fn disable_ambient_pet_for_session(&mut self) {
        self.ambient_pet = None;
        self.request_redraw();
    }

    pub fn ambient_pet_draw(
        &self,
        area: Rect,
    ...
    pub fn pet_picker_preview_draw(&self) -> Option<crate::pets::AmbientPetDraw> {
        self.bottom_pane
    ...
    pub fn should_clear_pet_picker_preview_image(&self) -> bool {
        self.pet_picker_preview_image_visible.replace(false)
    }

    pub fn fail_pet_picker_preview_render(&mut self, message: String) {
        self.pet_picker_preview_state.set_error(message);
        self.pet_picker_preview_pet = None;
        self.request_redraw();
    }

    pub fn open_pets_picker(&mut self) {
    ...
    pub fn select_pet_by_id(&mut self, pet_id: String) {
        if self.warn_if_pets_unsupported() {
            return;
        }
    ...
    pub fn set_tui_pet(&mut self, pet: Option<String>) {
    ...
    pub fn start_pet_picker_preview(&mut self, pet_id: String) {
    ...
    pub fn finish_pet_picker_preview_load(
        &mut self,
        request_id: u64,
    ...
    pub fn show_pet_selection_loading_popup(&mut self) -> u64 {
    ...
    pub fn finish_pet_selection_loading_popup(&mut self, request_id: u64) -> bool {
    ...
    #[cfg(any(test, feature = "test-support"))]
    pub fn set_pet_image_support_for_tests(&mut self, support: crate::pets::PetImageSupport) {
        self.pet_image_support_override = Some(support);
        self.apply_ambient_pet_image_support_override_for_tests();
    }

    #[cfg(any(test, feature = "test-support"))]
    pub fn install_test_ambient_pet_for_tests(&mut self, animations_enabled: bool) {
