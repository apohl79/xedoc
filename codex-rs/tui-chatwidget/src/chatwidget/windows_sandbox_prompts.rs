...
impl ChatWidget {
    ...
    pub fn windows_sandbox_mode_allowed(&self, mode: WindowsSandboxModeToml) -> bool {
        self.config
            .config_layer_stack
            .requirements()
    ...
    pub fn world_writable_warning_details(&self) -> Option<(Vec<String>, usize, bool)> {
        if self
            .config
            .notices
    ...
    #[cfg(target_os = "windows")]
    pub fn open_world_writable_warning_confirmation(
        &mut self,
    ...
    #[cfg(any(target_os = "windows", test))]
    pub fn open_windows_sandbox_enable_prompt(
        &mut self,
    ...
    #[cfg(any(target_os = "windows", test))]
    pub fn open_windows_sandbox_fallback_prompt(
        &mut self,
        preset: ApprovalPreset,
        profile_selection: Option<PermissionProfileSelection>,
    ) {
    ...
    #[cfg(target_os = "windows")]
    pub fn maybe_prompt_windows_sandbox_enable(&mut self, show_now: bool) {
    ...
    #[cfg(not(target_os = "windows"))]
    pub fn maybe_prompt_windows_sandbox_enable(&mut self, _show_now: bool) {}

    #[cfg(target_os = "windows")]
    pub fn show_windows_sandbox_setup_status(&mut self) {
    ...
    #[cfg(target_os = "windows")]
    pub fn clear_windows_sandbox_setup_status(&mut self) {
        self.bottom_pane
