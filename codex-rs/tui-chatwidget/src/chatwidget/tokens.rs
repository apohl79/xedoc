...
pub use chart::TokenActivityView;
...
impl ChatWidget {
    ...
    pub fn add_token_activity_output(&mut self, view: TokenActivityView) {
    ...
    pub fn finish_token_activity_refresh(
        &mut self,
        request_id: u64,
        result: Result<GetAccountTokenUsageResponse, String>,
    ) -> bool {
    ...
    pub fn usage_history_insertion_blocked(&self) -> bool {
    ...
    pub fn note_stream_consolidation_queued(&mut self) {
    ...
    pub fn note_stream_consolidation_completed(&mut self) {
        self.pending_stream_consolidations =
    ...
    pub fn take_completed_token_activity_output(&mut self) -> Option<CompositeHistoryCell> {
    ...
    pub fn request_pending_usage_output_insertion(&self) {
    ...
    pub fn request_pending_usage_output_insertion_after_stream_shutdown(&self) {
        if self.completed_token_activity_output.is_some()
            || self.pending_rate_limit_reset_hint().is_some()
        {
            self.app_event_tx
    ...
    pub fn clear_pending_token_activity_refreshes(&mut self) {
