...
impl ChatWidget {
    ...
    #[cfg_attr(not(target_os = "windows"), allow(dead_code))]
    pub fn set_windows_sandbox_mode(&mut self, mode: Option<WindowsSandboxModeToml>) {
    ...
    pub fn set_world_writable_warning_acknowledged(&mut self, acknowledged: bool) {
        self.config.notices.hide_world_writable_warning = Some(acknowledged);
    }

    #[cfg_attr(not(target_os = "windows"), allow(dead_code))]
    pub fn world_writable_warning_hidden(&self) -> bool {
        self.config
            .notices
    ...
    pub fn has_codex_backend_auth(&self) -> bool {
