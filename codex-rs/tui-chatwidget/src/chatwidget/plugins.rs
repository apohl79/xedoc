...
impl ChatWidget {
    pub fn add_plugins_output(&mut self) {
    ...
    pub fn on_plugins_list_fetch_started(&mut self, cwd: PathBuf) {
        if self.config.cwd.as_path() != cwd.as_path() {
            return;
        }
    ...
    pub fn open_plugins_list(&mut self, cwd: PathBuf, response: PluginListResponse) {
        if self.config.cwd.as_path() != cwd.as_path() {
            return;
        }
    ...
    pub fn open_marketplace_add_prompt(&mut self) {
    ...
    pub fn open_marketplace_add_loading_popup(&mut self, _source: &str) {
        self.plugins_active_tab_id = Some(ADD_MARKETPLACE_TAB_ID.to_string());
    ...
    pub fn open_marketplace_upgrade_loading_popup(&mut self, marketplace_name: Option<&str>) {
    ...
    pub fn open_marketplace_remove_confirmation(
        &mut self,
    ...
    pub fn open_marketplace_remove_loading_popup(&mut self, marketplace_display_name: &str) {
    ...
    pub fn open_plugin_detail_loading_popup(&mut self, plugin_display_name: &str) {
        self.plugins_active_tab_id = self
            .bottom_pane
            .active_tab_id_for_active_view(PLUGINS_SELECTION_VIEW_ID)
            .map(str::to_string)
    ...
    pub fn open_plugin_install_loading_popup(&mut self, plugin_display_name: &str) {
    ...
    pub fn open_plugin_uninstall_loading_popup(&mut self, plugin_display_name: &str) {
    ...
    pub fn on_plugin_detail_loaded(
        &mut self,
        cwd: PathBuf,
    ...
    pub fn on_marketplace_add_loaded(
        &mut self,
        cwd: PathBuf,
        _source: String,
    ...
    pub fn on_marketplace_remove_loaded(
        &mut self,
        cwd: PathBuf,
        marketplace_name: String,
        marketplace_display_name: String,
    ...
    pub fn on_marketplace_upgrade_loaded(
        &mut self,
        cwd: PathBuf,
    ...
    pub fn handle_plugins_popup_key_event(&mut self, key_event: KeyEvent) -> bool {
    ...
    pub fn on_plugin_uninstall_loaded(
        &mut self,
        cwd: PathBuf,
        plugin_display_name: String,
    ...
    pub fn advance_plugin_install_auth_flow(&mut self) {
        let should_finish = {
    ...
    pub fn abandon_plugin_install_auth_flow(&mut self) {
