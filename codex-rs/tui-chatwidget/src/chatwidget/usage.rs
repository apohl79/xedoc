...
impl ChatWidget {
    ...
    pub fn finish_usage_menu_rate_limit_refresh(
        &mut self,
        request_id: u64,
    ...
    pub fn show_rate_limit_reset_loading_popup(&mut self) -> u64 {
        self.clear_pending_rate_limit_reset_hint();
    ...
    pub fn finish_rate_limit_reset_credits_refresh(
        &mut self,
        request_id: u64,
        snapshots: Vec<RateLimitSnapshot>,
        result: Result<RateLimitResetCreditsSummary, String>,
    ...
    pub fn show_rate_limit_reset_confirmation(
        &mut self,
        picker_request_id: u64,
    ...
    pub fn start_rate_limit_reset_consumption(&mut self, idempotency_key: &str) -> Option<u64> {
    ...
    pub fn show_rate_limit_reset_consuming_popup(&mut self) -> u64 {
        self.clear_pending_rate_limit_reset_hint();
        self.pending_rate_limit_reset_idempotency_key = None;
        self.rate_limit_reset_picker_request_id = None;
        let request_id = self.take_next_rate_limit_reset_request_id();
    ...
    pub fn finish_rate_limit_reset_consume(
        &mut self,
        request_id: u64,
    ...
    pub fn finish_post_consume_reset_credits_refresh(
        &mut self,
        request_id: u64,
        snapshots: Vec<RateLimitSnapshot>,
        result: Result<RateLimitResetCreditsSummary, String>,
    ...
    pub fn start_rate_limit_reset_startup_check(&mut self) -> u64 {
        self.clear_pending_rate_limit_reset_hint();
        let request_id = self.take_next_rate_limit_reset_request_id();
    ...
    pub fn finish_rate_limit_reset_hint_refresh(
        &mut self,
        request_id: u64,
        snapshots: Vec<RateLimitSnapshot>,
        result: Result<RateLimitResetCreditsSummary, String>,
    ...
    pub fn clear_pending_rate_limit_reset_requests(&mut self) {
        self.pending_rate_limit_reset_request_id = None;
        self.pending_rate_limit_reset_idempotency_key = None;
        self.rate_limit_reset_picker_request_id = None;
        self.pending_usage_menu_rate_limit_request_id = None;
    ...
    pub fn clear_pending_rate_limit_reset_hint(&mut self) {
        self.pending_rate_limit_reset_hint_request_id = None;
    ...
    pub fn take_pending_rate_limit_reset_hint(&mut self) -> Option<PlainHistoryCell> {
