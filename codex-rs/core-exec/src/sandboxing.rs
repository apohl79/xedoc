...
pub struct ExecServerEnvConfig {
    pub policy: codex_exec_server::ExecEnvPolicy,
...
pub struct ExecRequest {
    ...
    pub windows_sandbox_filesystem_overrides: Option<WindowsSandboxFilesystemOverrides>,
...
impl ExecRequest {
    ...
    pub fn from_sandbox_exec_request(
