...
#[must_use]
pub struct TurnProfileTimingGuard {
...
impl TurnTimingState {
    ...
    pub fn complete_profile(&self) -> TurnProfile {
        self.profile_state().complete(Instant::now())
    }

    pub fn begin_sampling(self: &Arc<Self>) -> TurnProfileTimingGuard {
    ...
    pub fn record_sampling_retry(&self) {
        self.profile_state().record_sampling_retry();
    }

    pub fn begin_tool_blocking(self: &Arc<Self>) -> TurnProfileTimingGuard {
