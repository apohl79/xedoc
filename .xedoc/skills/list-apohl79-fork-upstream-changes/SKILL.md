...
2. Run the collector:
   ...
   ```bash
   python3 .xedoc/skills/list-apohl79-fork-upstream-changes/scripts/list_apohl79_fork_upstream_changes.py
   ```
...
```bash
python3 .xedoc/skills/list-apohl79-fork-upstream-changes/scripts/test_list_apohl79_fork_upstream_changes.py
```

Smoke-test the collector from this checkout:

```bash
python3 .xedoc/skills/list-apohl79-fork-upstream-changes/scripts/list_apohl79_fork_upstream_changes.py --no-fetch
```
