"""Command-line interface for building Xedoc package directories."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build a canonical Xedoc package directory and optional archive.",
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Include the Unix xedoc-session control CLI in the package.",
    )
    parser.add_argument(
        "--cargo",
        default="cargo",
...
def main() -> int:
    ...
    package_dir = (
        ...
        else Path(tempfile.mkdtemp(prefix="xedoc-package-")).resolve()
    )
