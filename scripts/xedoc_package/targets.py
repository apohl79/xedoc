...
PACKAGE_VARIANTS: dict[str, PackageVariant] = {
    "xedoc": PackageVariant(
        name="xedoc",
        cargo_bin="xedoc",
        executable_stem="xedoc",
    ),
    "xedoc-app-server": PackageVariant(
        name="xedoc-app-server",
        cargo_bin="xedoc-app-server",
        executable_stem="xedoc-app-server",
    ),
}
