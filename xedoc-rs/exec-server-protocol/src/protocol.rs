...
pub use xedoc_file_system::WalkOptions;
pub use xedoc_file_system::WalkOutcome;
...
use xedoc_shell_command::shell_detect::DetectedShell;
...
impl EnvironmentInfo {
    ...
    pub fn local() -> Self {
        Self {
            shell: xedoc_shell_command::shell_detect::default_user_shell().into(),
...
pub struct ExecParams {
    ...
    #[serde(default)]
    pub pipe_stdin: bool,
    /// Optional process-visible argv0 override. Values such as `xedoc-linux-sandbox` are command
