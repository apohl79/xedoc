...
use xedoc_collaboration_mode_templates::DEFAULT as COLLABORATION_MODE_DEFAULT;
use xedoc_collaboration_mode_templates::PLAN as COLLABORATION_MODE_PLAN;
use xedoc_protocol::config_types::CollaborationModeMask;
use xedoc_protocol::config_types::ModeKind;
use xedoc_protocol::config_types::TUI_VISIBLE_COLLABORATION_MODES;
