...
use crate::XEDOC_API_KEY_ENV_VAR;
...
impl AuthEnvTelemetry {
    pub fn to_otel_metadata(&self) -> AuthEnvTelemetryMetadata {
        AuthEnvTelemetryMetadata {
            ...
            xedoc_api_key_env_present: self.xedoc_api_key_env_present,
            xedoc_api_key_env_enabled: self.xedoc_api_key_env_enabled,
...
pub fn collect_auth_env_telemetry(
    ...
    xedoc_api_key_env_enabled: bool,
) -> AuthEnvTelemetry {
    AuthEnvTelemetry {
        openai_api_key_env_present: env_var_present(OPENAI_API_KEY_ENV_VAR),
        xedoc_api_key_env_present: env_var_present(XEDOC_API_KEY_ENV_VAR),
        xedoc_api_key_env_enabled,
...
mod tests {
    ...
    fn collect_auth_env_telemetry_buckets_provider_env_key_name() {
        ...
        let telemetry =
            collect_auth_env_telemetry(&provider, /*xedoc_api_key_env_enabled*/ false);
