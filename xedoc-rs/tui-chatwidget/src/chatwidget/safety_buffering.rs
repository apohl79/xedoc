...
const SAFETY_BUFFERING_FOOTER: &str = "No action is required. Xedoc will keep waiting, and this menu will close when the response is ready.";
...
impl ChatWidget {
    pub fn record_safety_buffering_turn(&mut self, turn_id: String, turn: &AppCommand) {
        self.safety_buffering.submitted_turn = Some((turn_id, turn.clone()));
        self.safety_buffering.accepted_steers.clear();
    }

    pub fn record_safety_buffering_steer(
        &mut self,
        turn_id: &str,
        pending_steer_id: Option<u64>,
        input: &[UserInput],
    ...
    pub fn record_safety_buffering_steer_canceled(&mut self, pending_steer_id: u64) {
        self.safety_buffering
            .accepted_steers
            .retain(|steer| steer.pending_steer_id != Some(pending_steer_id));
    }

    pub fn apply_safety_buffered_retry_input(
        &self,
        turn_id: &str,
        turn: &mut AppCommand,
    ...
    pub fn clear_safety_buffering(&mut self) {
        self.bottom_pane
            .dismiss_view_by_id(SAFETY_BUFFERING_PROMPT_VIEW_ID);
    ...
    pub fn can_retry_safety_buffered_turn(&self, turn_id: &str) -> bool {
    ...
    pub fn prepare_safety_buffered_retry_submission(&mut self, prompt: UserMessage) {
    ...
    pub fn commit_safety_buffered_retry_submission(&mut self, display: UserMessageDisplay) {
        self.on_user_message_display(display);
    }

    pub fn cancel_safety_buffered_retry_submission(&mut self) {
