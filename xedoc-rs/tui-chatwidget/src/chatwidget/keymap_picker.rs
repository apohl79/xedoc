...
impl ChatWidget {
    ...
    pub fn open_keymap_action_menu(
        &mut self,
        context: String,
        action: String,
    ...
    pub fn open_keymap_debug(&mut self, runtime_keymap: &RuntimeKeymap) {
    ...
    pub fn open_keymap_replace_binding_menu(
        &mut self,
        context: String,
        action: String,
        runtime_keymap: &RuntimeKeymap,
    ...
    /// a stale screen.
    pub fn return_to_keymap_picker(
        &mut self,
        context: &str,
        action: &str,
        runtime_keymap: &RuntimeKeymap,
