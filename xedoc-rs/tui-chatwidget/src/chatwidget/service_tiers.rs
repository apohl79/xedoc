...
use xedoc_protocol::openai_models::SPEED_TIER_FAST;
...
impl ChatWidget {
    ...
    pub fn current_service_tier(&self) -> Option<&str> {
        self.effective_service_tier.as_deref()
    }

    pub fn configured_service_tier(&self) -> Option<String> {
        self.config.service_tier.clone()
    }

    pub fn service_tier_update_for_core(&self) -> Option<Option<String>> {
    ...
    pub fn should_show_fast_status(&self, model: &str, service_tier: Option<&str>) -> bool {
    ...
    pub fn can_toggle_fast_mode_from_keybinding(&self) -> bool {
    ...
    pub fn toggle_fast_mode_from_ui(&mut self) {
    ...
    pub fn toggle_service_tier_from_ui(&mut self, command: ServiceTierCommand) {
