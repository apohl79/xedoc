...
impl ChatWidget {
    ...
    pub fn handle_thread_session(&mut self, session: ThreadSessionState) {
    ...
    pub fn handle_thread_session_quiet(&mut self, session: ThreadSessionState) {
        self.instruction_source_paths = session.instruction_source_paths.clone();
        self.on_session_configured_with_display_and_fork_parent_title(
            session,
    ...
    pub fn handle_prompt_edit_thread_session(&mut self, session: ThreadSessionState) {
        self.instruction_source_paths = session.instruction_source_paths.clone();
        let fork_parent_title = session.fork_parent_title.clone();
        self.on_session_configured_with_display_and_fork_parent_title(
            session,
    ...
    pub fn handle_side_thread_session(&mut self, session: ThreadSessionState) {
        self.instruction_source_paths = session.instruction_source_paths.clone();
        let fork_parent_title = session.fork_parent_title.clone();
        self.on_session_configured_with_display_and_fork_parent_title(
            session,
    ...
    pub fn emit_prompt_edit_thread_event(&mut self) {
    ...
    pub(super) fn on_thread_name_updated(
        ...
        source: xedoc_app_server_protocol::ThreadNameUpdateSource,
    ) {
        if self.thread_id == Some(thread_id) {
            if source == xedoc_app_server_protocol::ThreadNameUpdateSource::User
