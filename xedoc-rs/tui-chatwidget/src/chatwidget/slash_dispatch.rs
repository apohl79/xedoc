        ...
        match cmd {
            ...
            SlashCommand::Archive => {
                self.bottom_pane.show_selection_view(SelectionViewParams {
                    ...
                    subtitle: Some(
                        "Are you sure? This will archive the current session and exit Xedoc"
                            .to_string(),
                    ),
            ...
            SlashCommand::Rename => {
                self.session_telemetry
                    .counter("xedoc.thread.rename", /*inc*/ 1, &[]);
            ...
            SlashCommand::ModelRouter => {
                self.app_event_tx.send(AppEvent::OpenModelRouterSettings);
            }
            ...
            SlashCommand::ModelRouter => {
                ...
                match (parts.next(), parts.next(), parts.next()) {
                    ...
                    _ => self.add_error_message(
                        "Model-router settings are script-owned. Use `/model-router`.".to_string(),
                    ),
                }
            }
