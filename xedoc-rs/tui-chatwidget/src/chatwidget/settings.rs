...
impl ChatWidget {
    ...
    pub fn set_approval_policy(&mut self, policy: AskForApproval) {
        if let Err(err) = self
            .config
            .permissions
            .approval_policy
    ...
    pub fn status_account_display(&self) -> Option<&StatusAccountDisplay> {
        self.status_account_display.as_ref()
    }

    pub fn runtime_model_provider_base_url(&self) -> Option<&str> {
    ...
    pub fn has_xedoc_backend_auth(&self) -> bool {
        self.has_xedoc_backend_auth
    }
    ...
    pub fn update_account_state(
        ...
        self.has_xedoc_backend_auth = has_xedoc_backend_auth;
        self.refresh_status_surfaces();
    }
    ...
    pub fn set_model_provider(&mut self, provider_id: &str) {
    ...
    pub fn on_thread_settings_updated(&mut self, notification: ThreadSettingsUpdatedNotification) {
    ...
    pub fn effective_collaboration_mode(&self) -> CollaborationMode {
        if !self.collaboration_modes_enabled() {
    ...
    pub fn set_collaboration_mask_from_user_action(&mut self, mask: CollaborationModeMask) {
    ...
    pub fn set_collaboration_mask(&mut self, mut mask: CollaborationModeMask) {
            ...
            && (previous_model != next_model || previous_effort != next_effort)
        {
            ...
            if !next_model.starts_with("xedoc-auto-") {
