...
use xedoc_protocol::mcp_approval_meta::APPROVAL_KIND_KEY as MCP_TOOL_APPROVAL_KIND_KEY;
use xedoc_protocol::mcp_approval_meta::APPROVAL_KIND_MCP_TOOL_CALL as MCP_TOOL_APPROVAL_KIND_MCP_TOOL_CALL;
use xedoc_protocol::mcp_approval_meta::PERSIST_ALWAYS as MCP_TOOL_APPROVAL_PERSIST_ALWAYS;
use xedoc_protocol::mcp_approval_meta::PERSIST_KEY as MCP_TOOL_APPROVAL_PERSIST_KEY;
use xedoc_protocol::mcp_approval_meta::PERSIST_SESSION as MCP_TOOL_APPROVAL_PERSIST_SESSION;
use xedoc_protocol::mcp_approval_meta::TOOL_DESCRIPTION_KEY as MCP_TOOL_APPROVAL_TOOL_DESCRIPTION_KEY;
use xedoc_protocol::mcp_approval_meta::TOOL_PARAMS_DISPLAY_KEY as MCP_TOOL_APPROVAL_TOOL_PARAMS_DISPLAY_KEY;
use xedoc_protocol::mcp_approval_meta::TOOL_PARAMS_KEY as MCP_TOOL_APPROVAL_TOOL_PARAMS_KEY;
use xedoc_protocol::mcp_approval_meta::TOOL_TITLE_KEY as MCP_TOOL_APPROVAL_TOOL_TITLE_KEY;
use xedoc_protocol::protocol::McpInvocation;
use xedoc_protocol::request_user_input::RequestUserInputAnswer;
use xedoc_protocol::request_user_input::RequestUserInputQuestion;
use xedoc_protocol::request_user_input::RequestUserInputQuestionOption;
...
pub struct McpToolApprovalMetadata {
    ...
    /// Stable Xedoc App connector identifier.
    ...
    /// Resource URI rendered by a Xedoc App tool.
...
pub struct McpToolApprovalKey {
    ...
    pub server: String,
    /// Stable Xedoc App connector identifier, when one applies.
    pub connector_id: Option<String>,
    /// MCP tool name.
...
#[doc(hidden)]
pub const MCP_TOOL_APPROVAL_DECLINE_SYNTHETIC: &str = "__xedoc_mcp_decline__";
