...
pub use xedoc_utils_path::is_wsl;
...
mod tests {
    ...
    fn win_to_wsl_basic() {
        assert_eq!(
            win_path_to_wsl(r"C:\Temp\xedoc.zip").as_deref(),
            Some("/mnt/c/Temp/xedoc.zip")
        );
        assert_eq!(
            win_path_to_wsl("D:/Work/xedoc.tgz").as_deref(),
            Some("/mnt/d/Work/xedoc.tgz")
        );
        assert!(win_path_to_wsl("/home/user/xedoc").is_none());
    }
