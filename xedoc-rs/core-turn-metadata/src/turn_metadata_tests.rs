...
use xedoc_core_client::responses_metadata::CompactionTurnMetadata;
use xedoc_core_client::responses_metadata::INSTALLATION_ID_KEY;
use xedoc_core_client::responses_metadata::WINDOW_ID_KEY;
...
fn test_turn_responses_metadata_json(state: &TurnMetadataState, window_id: &str) -> String {
    test_responses_metadata_json(state, window_id, XedocResponsesRequestKind::Turn)
}
...
fn test_compaction_responses_metadata_json(
    ...
    test_responses_metadata_json(
        state,
        window_id,
        XedocResponsesRequestKind::Compaction(compaction),
    )
}
