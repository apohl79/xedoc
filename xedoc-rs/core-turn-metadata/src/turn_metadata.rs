...
use xedoc_core_client::responses_metadata::TurnMetadataWorkspace;
use xedoc_core_client::responses_metadata::XedocResponsesMetadata;
use xedoc_core_client::responses_metadata::XedocResponsesRequestKind;
use xedoc_core_client::responses_metadata::filter_extra_metadata;
use xedoc_core_client::responses_metadata::subagent_header_value;
use xedoc_core_client::responses_metadata::subagent_metadata_kind;
use xedoc_git_utils::get_git_remote_urls_assume_git_repo;
use xedoc_git_utils::get_git_repo_root;
use xedoc_git_utils::get_has_changes;
use xedoc_git_utils::get_head_commit_hash;
...
impl TurnMetadataState {
    ...
    pub fn to_responses_metadata(
        ...
        window_id: String,
        request_kind: XedocResponsesRequestKind,
    ...
    fn responses_metadata_template(&self) -> XedocResponsesMetadata {
        XedocResponsesMetadata {
