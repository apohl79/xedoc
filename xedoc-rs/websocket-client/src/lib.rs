//! Proxy-aware WebSocket connection setup shared by Xedoc API clients.
...
use xedoc_http_client::build_rustls_client_config_with_custom_ca;
...
impl WebSocketConnector {
    /// Creates a connector using native roots and any configured Xedoc custom CA bundle.
    pub fn new(
        http_client_factory: &HttpClientFactory,
