//! Rollout persistence and discovery for Xedoc session files.
...
pub(crate) use xedoc_protocol::protocol;
...
pub use session_index::find_thread_name_record_by_id;
pub use session_index::find_thread_name_records_by_ids;
...
pub use xedoc_protocol::protocol::SessionMeta;
