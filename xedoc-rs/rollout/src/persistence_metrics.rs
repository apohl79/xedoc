...
const ITEM_BYTES_METRIC: &str = "xedoc.rollout.persistence.item_bytes";
const APPEND_METRIC: &str = "xedoc.rollout.persistence.append";
const TURN_BYTES_METRIC: &str = "xedoc.rollout.persistence.turn_bytes";
const MEASUREMENT_ERROR_METRIC: &str = "xedoc.rollout.persistence.measurement_error";
