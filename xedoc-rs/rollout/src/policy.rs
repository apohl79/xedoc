...
pub fn is_persisted_rollout_item(item: &RolloutItem, history_mode: ThreadHistoryMode) -> bool {
    match item {
        ...
        // Persist Xedoc executive markers so we can analyze flows (e.g., compaction, API turns).
...
pub fn should_persist_event_msg(ev: &EventMsg, history_mode: ThreadHistoryMode) -> bool {
    match ev {
        ...
        | EventMsg::ModelRouterDecision(_) => true,
        ...
        | EventMsg::ModelRouterApprovalRequest(_)
