...
use xedoc_otel::ORIGINATOR_TAG;
use xedoc_otel::bounded_originator_tag_value;
use xedoc_state::DbTelemetry;
use xedoc_state::DbTelemetryHandle;
...
pub(crate) fn recorder(metrics: xedoc_otel::MetricsClient, originator: &str) -> DbTelemetryHandle {
