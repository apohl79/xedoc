...
//!
//! RMCP clients call into this module when a server asks Xedoc to elicit data
//! from the user. It decides whether the request can be automatically accepted,
//! must be declined by policy, or should be surfaced as a Xedoc protocol event
...
use xedoc_rmcp_client::Elicitation;
use xedoc_rmcp_client::ElicitationResponse;
use xedoc_rmcp_client::SendElicitation;
...
/// generated by Xedoc rather than copied from the MCP connection, so separate runtimes may reuse
