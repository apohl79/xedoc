//! Aggregates MCP server connections for Xedoc.
//!
...
use xedoc_config::McpServerAuth;
...
use xedoc_protocol::protocol::McpStartupCompleteEvent;
use xedoc_protocol::protocol::McpStartupFailure;
use xedoc_protocol::protocol::McpStartupFailureReason;
use xedoc_protocol::protocol::McpStartupStatus;
use xedoc_protocol::protocol::McpStartupUpdateEvent;
use xedoc_rmcp_client::ElicitationResponse;
use xedoc_rmcp_client::McpAuthState;
use xedoc_rmcp_client::McpLoginRequirement;
use xedoc_rmcp_client::determine_streamable_http_auth_status_from_credentials;
...
impl McpConnectionManager {
    ...
    pub async fn new(
        ...
        let chatgpt_auth_provider = auth
            .filter(|auth| auth.uses_xedoc_backend())
            .map(xedoc_model_provider::auth_provider_from_auth);
