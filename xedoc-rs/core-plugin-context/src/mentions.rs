...
use xedoc_core_skills::injection::ToolMentionKind;
use xedoc_core_skills::injection::extract_tool_mentions_with_sigil;
use xedoc_core_skills::injection::plugin_config_name_from_path;
use xedoc_core_skills::injection::tool_kind_for_path;
