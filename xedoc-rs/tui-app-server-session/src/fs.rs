...
impl AppServerSession {
    pub async fn fs_create_directory_all_path(&mut self, path: &AppServerPath) -> Result<()> {
    ...
    pub async fn fs_write_file_path(&mut self, path: &AppServerPath, bytes: Vec<u8>) -> Result<()> {
    ...
    pub async fn fs_read_file_path(&mut self, path: &AppServerPath) -> Result<Vec<u8>> {
    ...
    pub async fn fs_remove_path(&mut self, path: &AppServerPath) -> Result<()> {
