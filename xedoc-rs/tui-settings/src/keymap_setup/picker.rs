...
pub const KEYMAP_PICKER_VIEW_ID: &str = "keymap-picker";
...
pub fn build_keymap_picker_params_with_filter(
    runtime_keymap: &RuntimeKeymap,
    keymap_config: &TuiKeymap,
...
pub fn build_keymap_picker_params_for_selected_action_with_filter(
    runtime_keymap: &RuntimeKeymap,
    keymap_config: &TuiKeymap,
    action_filter: KeymapActionFilter,
    context: &str,
...
fn keymap_debug_tab() -> SelectionTab {
    SelectionTab {
        ...
        header: keymap_header(
            ...
            "See the key Xedoc detects and any shortcuts assigned to it.".to_string(),
        ),
