...
//! "leave the old title alone" or "clear the title Xedoc last wrote".
...
pub enum SetTerminalTitleResult {
    ...
    /// the title Xedoc manages, or some other fallback.
    NoVisibleContent,
}
...
pub fn set_terminal_title(title: &str) -> io::Result<SetTerminalTitleResult> {
...
/// or a previous program may have set before Xedoc started managing the title.
