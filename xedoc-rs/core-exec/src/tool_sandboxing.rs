...
pub enum ToolError {
    ...
    Rejected(String),
    /// Xedoc failed while preparing or running the request.
    Xedoc(XedocErr),
}
...
pub struct SandboxAttempt<'a> {
    ...
    pub permissions: &'a xedoc_protocol::models::PermissionProfile,
    /// Canonical permissions before this host materializes workspace roots.
    pub exec_server_permissions: &'a xedoc_protocol::models::PermissionProfile,
    ...
    pub xedoc_linux_sandbox_exe: Option<&'a std::path::PathBuf>,
