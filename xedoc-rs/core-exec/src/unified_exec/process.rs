...
use xedoc_exec_server::ExecProcessEvent;
use xedoc_exec_server::ProcessSignal as ExecServerProcessSignal;
use xedoc_exec_server::ReadResponse as ExecReadResponse;
...
use xedoc_utils_pty::SpawnedPty;
...
impl UnifiedExecProcess {
    ...
    pub async fn terminate_confirmed(&self) -> Result<(), UnifiedExecError> {
        match &self.process_handle {
            ProcessHandle::Local(process_handle) => process_handle.terminate(),
            ProcessHandle::ExecServer(process_handle) => {
                process_handle
    ...
    pub async fn interrupt(&self) -> Result<(), UnifiedExecError> {
        match &self.process_handle {
            ProcessHandle::Local(process_handle) => process_handle
    ...
    pub async fn check_for_sandbox_denial(&self) -> Result<(), UnifiedExecError> {
        let _ =
    ...
    pub async fn from_spawned(
        ...
        let output_rx = xedoc_utils_pty::combine_output_receivers(stdout_rx, stderr_rx);
