...
pub fn tab_bar_height(tabs: &[SelectionTab], active_idx: usize, width: u16) -> u16 {
    if tabs.is_empty() {
        return 0;
    }
...
pub fn render_tab_bar(tabs: &[SelectionTab], active_idx: usize, area: Rect, buf: &mut Buffer) {
