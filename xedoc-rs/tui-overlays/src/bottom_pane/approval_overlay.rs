...
pub use crate::app_event::ApplyPatchApprovalRequest;
pub use crate::app_event::ApprovalRequest;
pub use crate::app_event::ExecApprovalRequest;
pub use crate::app_event::McpElicitationApprovalRequest;
pub use crate::app_event::PermissionsApprovalRequest;
...
use xedoc_app_server_protocol::FileSystemAccessMode;
use xedoc_app_server_protocol::FileSystemPath;
use xedoc_app_server_protocol::FileSystemSandboxEntry;
use xedoc_app_server_protocol::FileSystemSpecialPath;
use xedoc_app_server_protocol::McpServerElicitationAction;
use xedoc_app_server_protocol::NetworkApprovalContext;
use xedoc_app_server_protocol::NetworkApprovalProtocol;
...
pub fn matches_resolved_request(
    approval: &ApprovalRequest,
    resolved: &ResolvedAppServerRequest,
) -> bool {
    approval.matches_resolved_request(resolved)
}
    ...
    available_decisions
        ...
        .filter_map(|decision| match decision {
            ...
            CommandExecutionApprovalDecision::Cancel => Some(ApprovalOption {
                label: "No, and tell Xedoc what to do differently".to_string(),
...
mod tests {
    ...
    use xedoc_app_server_protocol::ExecPolicyAmendment;
    use xedoc_app_server_protocol::NetworkApprovalProtocol;
    use xedoc_app_server_protocol::NetworkPolicyAmendment;
    ...
    fn network_exec_options_use_expected_labels_and_hide_execpolicy_amendment() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                "Yes, and allow this host for this conversation".to_string(),
                "Yes, and allow this host in the future".to_string(),
                "No, and tell Xedoc what to do differently".to_string(),
            ]
        );
    }
    ...
    fn exec_history_cell_wraps_with_two_space_indent() {
        ...
        let rendered: Vec<String> = lines
            ...
            .collect();
        let expected = vec![
            "✔ You approved xedoc to run".to_string(),
    ...
    fn network_access_command_history_uses_target_without_structured_context() {
        ...
        assert_eq!(
            ...
            vec![
                "✔ You approved xedoc network access to https://example.com:8443 this time"
                    .to_string(),
            ]
        );
    }
