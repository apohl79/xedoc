...
pub enum StatusSurfacePreviewItem {
    AppName,
    ProjectName,
    ProjectRoot,
    CurrentDir,
...
impl StatusSurfacePreviewItem {
    fn placeholder(self) -> &'static str {
        match self {
            StatusSurfacePreviewItem::AppName => "xedoc",
            ...
            StatusSurfacePreviewItem::XedocVersion => "0.0.0",
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct StatusSurfacePreviewData {
...
impl StatusSurfacePreviewData {
    ...
    pub fn set_live<V>(&mut self, item: StatusSurfacePreviewItem, value: V)
    where
        V: Into<String>,
    {
        self.values.insert(
    ...
    pub fn set_placeholder<V>(&mut self, item: StatusSurfacePreviewItem, value: V)
    where
        V: Into<String>,
    {
        if self
    ...
    pub fn suppress_placeholder(&mut self, item: StatusSurfacePreviewItem) {
        if self
            .values
            .get(&item)
            .is_some_and(|value| value.is_placeholder)
    ...
    pub fn rate_limit_item_name(&self, item: StatusSurfacePreviewItem, fallback: &str) -> String {
    ...
    pub fn rate_limit_item_description(
        &self,
    ...
    pub fn value_for(&self, item: StatusSurfacePreviewItem) -> Option<&str> {
    ...
    pub fn status_line_for_items<I>(
        &self,
        items: I,
