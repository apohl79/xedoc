...
impl StatusLineAccent {
    fn for_item(item: StatusLineItem) -> Self {
        match item {
            ...
            StatusLineItem::XedocVersion | StatusLineItem::SessionId => Self::Metadata,
...
pub fn status_line_from_segments<I>(segments: I, use_theme_colors: bool) -> Option<Line<'static>>
where
