...
impl TerminalTitleItem {
    pub fn description(self) -> &'static str {
        match self {
            TerminalTitleItem::AppName => "Xedoc app name",
            ...
            TerminalTitleItem::XedocVersion => "Xedoc application version",
    ...
    pub fn preview_item(self) -> Option<StatusSurfacePreviewItem> {
        match self {
            ...
            TerminalTitleItem::XedocVersion => Some(StatusSurfacePreviewItem::XedocVersion),
...
pub fn preview_line_for_title_items(
    ...
    pub fn new(
        ...
        Self {
            ...
            .on_change(|items, app_event| {
                ...
                app_event.send(AppEvent::TerminalTitleSetupPreview {
                    item_ids: items.iter().map(ToString::to_string).collect(),
                });
            })
            .on_confirm(|ids, app_event| {
                ...
                app_event.send(AppEvent::TerminalTitleSetup {
                    item_ids: items.iter().map(ToString::to_string).collect(),
                });
            })
            .on_cancel(|app_event| {
    ...
    fn parse_terminal_title_items_accepts_kebab_case_variants() {
        ...
        assert_eq!(
            ...
            Some(vec![
                ...
                TerminalTitleItem::WeeklyLimit,
                TerminalTitleItem::XedocVersion,
