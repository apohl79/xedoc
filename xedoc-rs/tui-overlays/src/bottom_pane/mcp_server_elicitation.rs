...
use xedoc_app_server_protocol::McpElicitationEnumSchema;
use xedoc_app_server_protocol::McpElicitationPrimitiveSchema;
use xedoc_app_server_protocol::McpElicitationSingleSelectEnumSchema;
...
use xedoc_protocol::mcp_approval_meta::APPROVAL_KIND_KEY as APPROVAL_META_KIND_KEY;
use xedoc_protocol::mcp_approval_meta::APPROVAL_KIND_MCP_TOOL_CALL as APPROVAL_META_KIND_MCP_TOOL_CALL;
use xedoc_protocol::mcp_approval_meta::PERSIST_ALWAYS as APPROVAL_PERSIST_ALWAYS_VALUE;
use xedoc_protocol::mcp_approval_meta::PERSIST_KEY as APPROVAL_PERSIST_KEY;
use xedoc_protocol::mcp_approval_meta::PERSIST_SESSION as APPROVAL_PERSIST_SESSION_VALUE;
use xedoc_protocol::mcp_approval_meta::TOOL_PARAMS_DISPLAY_KEY as APPROVAL_TOOL_PARAMS_DISPLAY_KEY;
use xedoc_protocol::mcp_approval_meta::TOOL_PARAMS_KEY as APPROVAL_TOOL_PARAMS_KEY;
...
impl McpServerElicitationFormRequest {
    pub fn from_app_server_request(
        thread_id: ThreadId,
        request_id: AppServerRequestId,
    ...
    pub fn request_id(&self) -> &AppServerRequestId {
        &self.request_id
    }
}
...
pub struct McpServerElicitationOverlay {
