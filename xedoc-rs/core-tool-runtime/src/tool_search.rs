    ...
    fn mixed_search_results_coalesce_mcp_namespaces() {
        let search_infos = vec![
            ...
            search_info(ToolSpec::Namespace(ResponsesApiNamespace {
                ...
                description: "Tools in the xedoc_app namespace.".to_string(),
