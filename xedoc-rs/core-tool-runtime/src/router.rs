...
use xedoc_protocol::models::SearchToolCallParams;
...
impl<S, C, D> ToolRouter<S, C, D> {
    ...
    pub fn build_tool_call(
        item: ResponseItem,
    ) -> Result<Option<ToolCall>, xedoc_tools::FunctionCallError> {
        match item {
            ...
            ResponseItem::ToolSearchCall {
                ...
                let arguments: SearchToolCallParams =
                    serde_json::from_value(arguments).map_err(|err| {
                        xedoc_tools::FunctionCallError::RespondToModel(format!(
    ...
    D: ToolDispatcher<S, C>,
{
    ...
    ) -> Result<AnyToolResult<D::PostToolUsePayload>, xedoc_tools::FunctionCallError> {
