...
const AUDIT_TARGET: &str = "xedoc_otel.network_proxy";
const POLICY_DECISION_EVENT_NAME: &str = "xedoc.network_proxy.policy_decision";
...
mod tests {
    ...
    const LEGACY_DOMAIN_POLICY_DECISION_EVENT_NAME: &str =
        "xedoc.network_proxy.domain_policy_decision";
    const LEGACY_BLOCK_DECISION_EVENT_NAME: &str = "xedoc.network_proxy.block_decision";
    ...
    async fn evaluate_host_policy_emits_domain_event_for_decider_allow_override() {
        ...
        assert!(event.target.starts_with("xedoc_otel."));
        assert_eq!(
