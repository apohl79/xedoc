...
use xedoc_websocket_client::WebSocketConnection;
use xedoc_websocket_client::WebSocketConnector;
...
const X_XEDOC_TURN_STATE_HEADER: &str = "x-codex-turn-state";
...
const RESPONSES_WEBSOCKET_TIMING_EVENT_TARGET: &str = "xedoc_api::responses_websocket_timing";
...
fn emit_responses_websocket_timing_event(
    ...
    // `RUST_LOG='xedoc_api::responses_websocket_timing=trace'`.
    tracing::event!(
