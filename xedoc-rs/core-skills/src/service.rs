...
impl SkillsService {
    pub fn new(xedoc_home: AbsolutePathBuf, bundled_skills_enabled: bool) -> Self {
        Self::new_with_restriction_product(xedoc_home, bundled_skills_enabled, Some(Product::Xedoc))
    }
    ...
    pub fn new_with_restriction_product(
        ...
        if !bundled_skills_enabled {
            ...
            uninstall_system_skills(&service.xedoc_home);
        } else if let Err(err) = install_system_skills(&service.xedoc_home) {
