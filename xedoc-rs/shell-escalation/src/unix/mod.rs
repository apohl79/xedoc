...
//! `EscalateRequest` over the inherited `XEDOC_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `XEDOC_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use xedoc_protocol::approvals::EscalationPermissions;
pub use xedoc_protocol::approvals::ResolvedPermissionProfile;
