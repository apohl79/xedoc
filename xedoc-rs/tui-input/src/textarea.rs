...
use xedoc_protocol::user_input::TextElement as UserTextElement;
...
impl TextArea {
    ...
    pub fn vim_normal_end_cursor(&self) -> usize {
    ...
    pub fn text_element_ranges(&self) -> impl Iterator<Item = &Range<usize>> {
    ...
    pub fn text_element_ranges_overlapping(
        &self,
        range: Range<usize>,
...
impl TextArea {
    ...
    pub fn render_ref_styled_with_highlights(
        &self,
        area: Rect,
        buf: &mut Buffer,
        state: &mut TextAreaState,
