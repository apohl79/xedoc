...
pub use plugin::migrate_plugin_commands;
pub use plugin::migrated_command_skills_root;
...
/// Controls how migrated commands obtain the description required by a Xedoc skill.
