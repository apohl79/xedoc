...
use xedoc_protocol::config_types::WebSearchFilters as ConfigWebSearchFilters;
use xedoc_protocol::config_types::WebSearchUserLocation as ConfigWebSearchUserLocation;
