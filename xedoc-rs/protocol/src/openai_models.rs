//! Shared model metadata types exchanged between Xedoc services and clients.
//!
...
/// Metadata describing a Xedoc-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the Xedoc backend `/models` endpoint.
