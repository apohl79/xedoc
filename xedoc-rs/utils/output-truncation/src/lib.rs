//! Helpers for truncating tool and exec output using [`TruncationPolicy`](xedoc_protocol::protocol::TruncationPolicy).

use xedoc_protocol::models::FunctionCallOutputContentItem;
pub use xedoc_utils_string::approx_bytes_for_tokens;
pub use xedoc_utils_string::approx_token_count;
pub use xedoc_utils_string::approx_tokens_from_byte_count;
use xedoc_utils_string::truncate_middle_chars;
use xedoc_utils_string::truncate_middle_with_token_budget;

pub use xedoc_protocol::protocol::TruncationPolicy;
