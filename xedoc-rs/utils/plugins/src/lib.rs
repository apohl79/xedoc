//! Plugin path resolution, plaintext mention sigils, and MCP connector helpers shared across Xedoc
//! crates.
...
pub use xedoc_exec_server_protocol::DISCOVERABLE_PLUGIN_MANIFEST_PATHS;
