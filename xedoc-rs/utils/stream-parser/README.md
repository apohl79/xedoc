# xedoc-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Disclaimer**: This code is pretty complex and Xedoc did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust Xedoc on it. Feel free to update the documentation as you
modify the code
...
```rust
use xedoc_utils_stream_parser::CitationStreamParser;
use xedoc_utils_stream_parser::StreamTextParser;
...
```rust
use xedoc_utils_stream_parser::CitationStreamParser;
use xedoc_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), xedoc_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use xedoc_utils_stream_parser::InlineHiddenTagParser;
use xedoc_utils_stream_parser::InlineTagSpec;
use xedoc_utils_stream_parser::StreamTextParser;
