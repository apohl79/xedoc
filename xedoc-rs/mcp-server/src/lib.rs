...
mod patch_approval;
mod xedoc_tool_config;
mod xedoc_tool_runner;
...
pub use crate::xedoc_tool_config::XedocToolCallParam;
pub use crate::xedoc_tool_config::XedocToolCallReplyParam;

/// Size of the bounded channels used to communicate between tasks. The value
/// is a balance between throughput and memory usage – 128 messages should be
/// plenty for an interactive CLI.
const CHANNEL_CAPACITY: usize = 128;
const OTEL_SERVICE_NAME: &str = "xedoc_mcp_server";
...
pub async fn run_main(
    ...
    let environment_manager = Arc::new(
        EnvironmentManager::from_xedoc_home(
...
mod tests {
    ...
    async fn mcp_server_builds_otel_provider_with_logs_traces_and_metrics() -> anyhow::Result<()> {
        ...
        let provider =
            xedoc_core::otel_init::build_provider(&config, "0.0.0-test", Some(OTEL_SERVICE_NAME))
