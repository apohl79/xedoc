...
use xedoc_protocol::protocol::COLLABORATION_MODE_CLOSE_TAG;
use xedoc_protocol::protocol::COLLABORATION_MODE_OPEN_TAG;
            ...
            thread_settings: xedoc_protocol::protocol::ThreadSettingsOverrides {
                ...
                summary: Some(
                    test.config
                        ...
                        .unwrap_or(xedoc_protocol::config_types::ReasoningSummary::Auto),
                ),
                collaboration_mode: Some(collaboration_mode),
                ..Default::default()
            },
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn collaboration_mode_update_applies_instruction_changes_within_same_mode() -> Result<()> {
    skip_if_no_network!(Ok(()));
