...
use xedoc_core::context::ApprovalPromptContext;
use xedoc_core::context::ContextualUserFragment;
use xedoc_core::context::PermissionsInstructions;
use xedoc_core::load_exec_policy;
use xedoc_models_manager::model_info::model_info_from_slug;
...
) -> xedoc_protocol::openai_models::ModelInfo {
