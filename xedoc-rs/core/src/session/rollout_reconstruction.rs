...
impl From<xedoc_core_rollout_reconstruction::ReconstructedTurnSettings> for PreviousTurnSettings {
    fn from(settings: xedoc_core_rollout_reconstruction::ReconstructedTurnSettings) -> Self {
        Self {
...
impl Session {
    pub(super) async fn reconstruct_history_from_rollout(
        ...
        let reconstruction = xedoc_core_rollout_reconstruction::reconstruct_history_from_rollout(
