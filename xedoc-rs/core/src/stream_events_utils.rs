...
use tracing::warn;
use xedoc_core_response_items::completed_item_defers_mailbox_delivery_to_next_turn;
pub(crate) use xedoc_core_response_items::last_assistant_message_from_item;
pub(crate) use xedoc_core_response_items::raw_assistant_output_text_from_item;
use xedoc_core_response_items::response_input_to_response_item;
use xedoc_core_response_items::sanitize_agent_message;
...
pub(crate) async fn handle_output_item_done(
    ...
    match ToolRouter::build_tool_call(item.clone()) {
        ...
        Err(FunctionCallError::Fatal(message)) => {
            return Err(XedocErr::Fatal(message));
        }
    }
