...
use crate::unified_exec::OutputBuffer;
...
fn exec_env_policy_from_shell_policy(
    ...
    let mut exclude = policy
        ...
        .collect::<Vec<_>>();
    exclude.push(XEDOC_PERMISSION_PROFILE_ENV_VAR.to_string());
    let mut r#set = policy.r#set.clone();
    r#set.retain(|key, _| !key.eq_ignore_ascii_case(XEDOC_PERMISSION_PROFILE_ENV_VAR));
    xedoc_exec_server::ExecEnvPolicy {
...
fn env_overlay_for_exec_server(
    ...
    request_env
        .iter()
        .filter(|(key, value)| {
            key.as_str() == XEDOC_PERMISSION_PROFILE_ENV_VAR
...
fn exec_server_env_for_request(
    ...
    Option<xedoc_exec_server::ExecEnvPolicy>,
    HashMap<String, String>,
) {
...
fn network_approval_error_message(err: ToolError) -> String {
    match err {
        ...
        ToolError::Xedoc(err) => err.to_string(),
    }
}
...
impl UnifiedExecProcessManager {
    ...
    pub(crate) async fn open_session_with_exec_env(
        ...
        network_proxy_launch: Option<xedoc_network_proxy::RemoteNetworkProxyLaunchConfig>,
        ...
        .map_err(|err| match err {
            UnifiedExecError::SandboxDenied { output, .. } => {
                ToolError::Xedoc(XedocErr::Sandbox(SandboxErr::Denied {
    ...
    pub(crate) async fn open_session_with_prepared_exec_env(
        ...
        let spawn_result = xedoc_sandboxing::spawn_process(xedoc_sandboxing::SpawnRequest {
    ...
    pub(super) async fn open_session_with_sandbox(
        ...
        orchestrator
            ...
            .map_err(|err| match err {
                ToolError::Xedoc(XedocErr::Sandbox(SandboxErr::Denied { output, .. })) => {
                    let output = *output;
