...
use xedoc_tools::TOOL_SEARCH_TOOL_NAME;
use xedoc_tools::ToolCall as ExtensionToolCall;
use xedoc_tools::ToolEnvironmentMode;
...
use xedoc_tools::can_request_original_image_detail;
use xedoc_tools::default_namespace_description;
use xedoc_tools::request_user_input_available_modes;
use xedoc_tools::shell_command_backend_for_features;
use xedoc_tools::shell_type_for_model_and_features;
    ...
    provider.uses_openai_actor_authorization()
        || (provider.requires_openai_auth
            && turn_context
                .auth_manager
                .as_deref()
                .is_some_and(AuthManager::current_auth_uses_xedoc_backend))
}
