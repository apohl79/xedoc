...
pub use xedoc_core_tool_runtime::ToolCall;
pub(crate) use xedoc_core_tool_runtime::ToolCallSource;
pub(crate) use xedoc_core_tool_runtime::ToolDispatcher;

type CoreToolRouter = xedoc_core_tool_runtime::ToolRouter<Session, StepContext, ToolRegistry>;
