...
use xedoc_otel::ToolDecisionSource;
...
impl ToolOrchestrator {
        ...
        T: ToolRuntime<Rq, Out>,
    {
        ...
        let attempt_with_network_approval = SandboxAttempt {
            ...
            xedoc_linux_sandbox_exe: attempt.xedoc_linux_sandbox_exe,
        ...
        T: ToolRuntime<Rq, Out>,
    {
        ...
        let initial_attempt = SandboxAttempt {
            ...
            workspace_roots,
            xedoc_linux_sandbox_exe: turn_ctx.config.xedoc_linux_sandbox_exe.as_ref(),
            use_legacy_landlock,
        ...
        match first_result {
            ...
            Err(ToolError::Xedoc(XedocErr::Sandbox(SandboxErr::Denied {
                output,
                ...
                let retry_xedoc_linux_sandbox_exe = if unsandboxed_allowed {
                    None
                } else {
                    turn_ctx.config.xedoc_linux_sandbox_exe.as_ref()
                };
                let retry_attempt = SandboxAttempt {
                    ...
                    sandbox_cwd: &sandbox_policy_cwd,
                    workspace_roots,
                    xedoc_linux_sandbox_exe: retry_xedoc_linux_sandbox_exe,
                    use_legacy_landlock,
                    network_denial_cancellation_token: None,
                    network_proxy: None,
                };
...
fn sandbox_outcome_from_tool_error(err: &ToolError) -> Option<&'static str> {
    match err {
        ToolError::Xedoc(XedocErr::Sandbox(SandboxErr::Denied { .. })) => Some("denied"),
        ToolError::Xedoc(XedocErr::Sandbox(SandboxErr::Timeout { .. })) => Some("timed_out"),
        ToolError::Xedoc(XedocErr::Sandbox(SandboxErr::Signal(_))) => Some("signal"),
        ToolError::Rejected(_) | ToolError::Xedoc(_) => None,
    }
}
