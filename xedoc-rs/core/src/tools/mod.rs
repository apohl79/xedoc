...
pub(crate) use xedoc_core_tool_specs::hosted_spec;
...
) -> xedoc_tools::ToolUserShellType {
    match user_shell.shell_type {
        crate::shell::ShellType::Zsh => xedoc_tools::ToolUserShellType::Zsh,
        crate::shell::ShellType::Bash => xedoc_tools::ToolUserShellType::Bash,
        crate::shell::ShellType::PowerShell => xedoc_tools::ToolUserShellType::PowerShell,
        crate::shell::ShellType::Sh => xedoc_tools::ToolUserShellType::Sh,
        crate::shell::ShellType::Cmd => xedoc_tools::ToolUserShellType::Cmd,
    }
}
