...
/// Resolved configuration shared by all Xedoc SQLite connections.
...
impl SqliteConfig {
    ...
    /// Open a writable Xedoc SQLite database, creating it if necessary.
    ...
    /// Open an existing Xedoc SQLite database without creating or modifying it.
