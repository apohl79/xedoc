...
pub struct CreateThreadParams {
    ...
    /// Thread id generated by Xedoc before opening persistence.
...
mod tests {
    ...
    fn session_meta(history_mode: ThreadHistoryMode) -> RolloutItem {
        RolloutItem::SessionMeta(xedoc_protocol::protocol::SessionMetaLine {
            meta: xedoc_protocol::protocol::SessionMeta {
                history_mode,
                ..Default::default()
            },
            git: None,
