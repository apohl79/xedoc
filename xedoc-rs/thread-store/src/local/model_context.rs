...
use xedoc_rollout::ModelContextScan;
use xedoc_rollout::ModelContextScanProgress;
use xedoc_rollout::ReverseJsonlScanner;
use xedoc_rollout::ScanOutcome;
...
pub(super) async fn load_latest_model_context(
    ...
    let session_meta = xedoc_rollout::read_session_meta_line(path.as_path())
        .await
