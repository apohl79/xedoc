...
use tracing::warn;
use xedoc_app_server_protocol::ThreadHistoryChangeSet;
use xedoc_app_server_protocol::project_rollout_line;
...
pub(super) async fn materialize_to_sqlite(
    ...
    let subagent_history_start_ordinal = xedoc_rollout::read_session_meta_line(rollout_path)
        .await
