...
pub(crate) async fn prepare_exec_request(
    ...
    #[cfg(target_os = "linux")]
    let sandbox_helper_paths = std::iter::once(&runtime_paths.xedoc_self_exe)
        .chain(runtime_paths.xedoc_linux_sandbox_exe.as_ref())
        .cloned()
        .collect::<Vec<_>>();
    #[cfg(target_os = "linux")]
    ...
    let request = sandbox_manager
        .transform(SandboxTransformRequest {
            ...
            network: None,
            sandbox_policy_cwd,
            xedoc_linux_sandbox_exe: runtime_paths.xedoc_linux_sandbox_exe.as_deref(),
