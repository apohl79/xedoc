...
use xedoc_protocol::models::is_audio_close_tag_text;
use xedoc_protocol::models::is_audio_open_tag_text;
use xedoc_protocol::models::is_image_close_tag_text;
use xedoc_protocol::models::is_image_open_tag_text;
use xedoc_protocol::models::is_local_audio_close_tag_text;
use xedoc_protocol::models::is_local_audio_open_tag_text;
use xedoc_protocol::models::is_local_image_close_tag_text;
use xedoc_protocol::models::is_local_image_open_tag_text;
use xedoc_protocol::user_input::UserInput;

use crate::web_search::web_search_action_detail;
use xedoc_core_context::parse_visible_hook_prompt_message;
...
pub fn parse_turn_item(item: &ResponseItem) -> Option<TurnItem> {
    match item {
        ...
        ResponseItem::ImageGenerationCall {
            ...
            xedoc_protocol::items::ImageGenerationItem {
