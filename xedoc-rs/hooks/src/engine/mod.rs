...
pub(crate) struct ConfiguredHandler {
    pub event_name: xedoc_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            xedoc_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            xedoc_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            xedoc_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            xedoc_protocol::protocol::HookEventName::PreCompact => "pre-compact",
            xedoc_protocol::protocol::HookEventName::PostCompact => "post-compact",
            xedoc_protocol::protocol::HookEventName::SessionStart => "session-start",
            xedoc_protocol::protocol::HookEventName::SessionEnd => "session-end",
            xedoc_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
            xedoc_protocol::protocol::HookEventName::SubagentStart => "subagent-start",
            xedoc_protocol::protocol::HookEventName::SubagentStop => "subagent-stop",
            xedoc_protocol::protocol::HookEventName::Stop => "stop",
        }
    }
}
...
impl ClaudeHooksEngine {
    ...
    async fn maybe_spill_prompt_fragments(
        &self,
        session_id: ThreadId,
        fragments: Vec<xedoc_protocol::items::HookPromptFragment>,
    ) -> Vec<xedoc_protocol::items::HookPromptFragment> {
        self.output_spiller
