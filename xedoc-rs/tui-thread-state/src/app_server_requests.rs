...
use xedoc_tui_events::approval_conversions::granted_permission_profile_from_request;

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct AppServerRequestResolution {
    pub request_id: AppServerRequestId,
    pub result: serde_json::Value,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct UnsupportedAppServerRequest {
    pub request_id: AppServerRequestId,
    pub message: String,
}
...
pub struct PendingAppServerRequests {
...
impl PendingAppServerRequests {
    ...
    pub fn contains_server_request(&self, request: &ServerRequest) -> bool {
        match request {
...
mod tests {
    ...
    use xedoc_app_server_protocol::McpElicitationObjectType;
    use xedoc_app_server_protocol::McpElicitationSchema;
    ...
    use xedoc_app_server_protocol::PermissionGrantScope;
    ...
    use xedoc_tui_events::AppCommand as Op;
    ...
    fn rejects_permissions_with_paths_that_cannot_be_localized() {
        ...
        let permissions = xedoc_app_server_protocol::RequestPermissionProfile {
            network: None,
    ...
    fn resolves_permissions_and_user_input_through_app_server_request_id() {
        ...
        let permissions = pending
            .take_resolution(&Op::RequestPermissionsResponse {
                id: "perm-1".to_string(),
                response: xedoc_protocol::request_permissions::RequestPermissionsResponse {
                    ...
                    scope: xedoc_protocol::request_permissions::PermissionGrantScope::Session,
                },
            })
        ...
        assert_eq!(
            ...
            PermissionsRequestApprovalResponse {
                permissions: xedoc_app_server_protocol::GrantedPermissionProfile {
                    ...
                    file_system: Some(AdditionalFileSystemPermissions {
                        ...
                        glob_scan_max_depth: None,
                        entries: Some(vec![
                            xedoc_app_server_protocol::FileSystemSandboxEntry {
                                path: xedoc_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(read_path).into(),
                                },
                                access: xedoc_app_server_protocol::FileSystemAccessMode::Read,
                            },
                            xedoc_app_server_protocol::FileSystemSandboxEntry {
                                path: xedoc_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(write_path).into(),
                                },
                                access: xedoc_app_server_protocol::FileSystemAccessMode::Write,
                            },
                        ]),
                    }),
                },
    ...
    fn rejects_dynamic_tool_calls_as_unsupported() {
        ...
        let unsupported = pending
            .note_server_request(&ServerRequest::DynamicToolCall {
                ...
                params: xedoc_app_server_protocol::DynamicToolCallParams {
                    thread_id: "thread-1".to_string(),
                    turn_id: "turn-1".to_string(),
    ...
    fn does_not_mark_chatgpt_auth_refresh_as_unsupported() {
        ...
        assert_eq!(
            pending.note_server_request(&ServerRequest::ChatgptAuthTokensRefresh {
                ...
                params: xedoc_app_server_protocol::ChatgptAuthTokensRefreshParams {
                    reason: xedoc_app_server_protocol::ChatgptAuthTokensRefreshReason::Unauthorized,
