pub(crate) const OTEL_TARGET_PREFIX: &str = "xedoc_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "xedoc_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "xedoc_otel.trace_safe";
