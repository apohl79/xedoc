...
/// Provenance for one layer in the effective Xedoc configuration.
...
pub enum ConfigLayerSource {
    ...
    /// Configuration loaded from a project's `.xedoc` directory.
    Project { dot_xedoc_folder: AbsolutePathBuf },
    ...
    match source {
        ...
        ConfigLayerSource::Project { dot_xedoc_folder } => {
            format!(
                ...
                dot_xedoc_folder.as_path().display()
            )
        }
