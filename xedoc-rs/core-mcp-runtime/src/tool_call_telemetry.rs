...
use xedoc_otel::sanitize_metric_tag_value;
use xedoc_protocol::mcp::CallToolResult;

const MCP_CALL_COUNT_METRIC: &str = "xedoc.mcp.call";
const MCP_CALL_DURATION_METRIC: &str = "xedoc.mcp.call.duration_ms";
const MCP_CALL_ERROR_COUNT_METRIC: &str = "xedoc.mcp.call.error";
...
const MCP_CALL_ERROR_CODE_SPAN_ATTR: &str = "xedoc.mcp.error.code";
const MCP_RESULT_TELEMETRY_META_KEY: &str = "xedoc/telemetry";
...
const MCP_RESULT_TELEMETRY_TARGET_ID_SPAN_ATTR: &str = "xedoc.mcp.target.id";
const MCP_RESULT_TELEMETRY_SERVER_USER_FLOW_SPAN_ATTR: &str =
    "xedoc.mcp.server_user_flow.triggered";
