use xedoc_core_plugins::manifest::parse_plugin_manifest_uri;
use xedoc_exec_server::CapabilityRootDiscovery;
use xedoc_mcp::parse_executor_plugin_mcp_config;
...
fn parse_mcp_servers(
    selected_root: &SelectedCapabilityRoot,
    plugin_root: &xedoc_utils_path_uri::PathUri,
    contents: &str,
    environment_id: &str,
) -> Vec<(String, xedoc_config::McpServerConfig)> {
