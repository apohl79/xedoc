...
use xedoc_api::ImageBackground;
use xedoc_api::ImageEditRequest;
use xedoc_api::ImageGenerationRequest;
use xedoc_api::ImageQuality;
use xedoc_api::ImageUrl;
...
use xedoc_extension_api::ToolEnvironment;
...
use xedoc_extension_api::parse_tool_input_schema;
...
use crate::backend::XedocImagesBackend;
...
impl ToolExecutor<ToolCall> for ImageGenerationTool {
    ...
    /// Exposes image generation directly to the model.
