...
impl RemoteAppServerClient {
    ...
    pub fn xedoc_home(&self) -> Option<&str> {
        self.xedoc_home.as_deref()
    }
        ...
        S: AsyncRead + AsyncWrite + Unpin + Send + 'static,
    {
        ...
        let (pending_events, server_version, xedoc_home) = initialize_remote_connection(
            &mut stream,
            &endpoint,
            initialize_params,
            INITIALIZE_TIMEOUT,
    ...
    S: AsyncRead + AsyncWrite + Unpin,
{
    ...
    Ok((pending_events, server_version, xedoc_home))
}
