...
#[test]
fn xedoc_hooks_is_legacy_alias_for_hooks() {
    assert_eq!(feature_for_key("hooks"), Some(Feature::XedocHooks));
    assert_eq!(feature_for_key("xedoc_hooks"), Some(Feature::XedocHooks));
}
