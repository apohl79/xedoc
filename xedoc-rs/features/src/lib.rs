...
pub enum Feature {
    ...
    Chronicle,
    /// Compress request bodies (zstd) when sending streaming requests to xedoc-backend.
    EnableRequestCompression,
    /// Start the managed network proxy for sandboxed sessions.
    NetworkProxy,
    /// Respect host system proxy settings for Xedoc-owned network clients.
    RespectSystemProxy,
    /// Enable collab tools.
    Collab,
    ...
    SpawnCsv,
    /// Removed compatibility flag for the deleted Xedoc Apps (connectors) integration.
    Apps,
    /// Enable MCP apps.
    EnableMcpApps,
    ...
    /// Prompt Xedoc Apps connector auth failures through MCP URL elicitations.
    AuthElicitation,
    ...
    FastMode,
    /// Removed: realtime voice conversation mode.
...
pub const FEATURES: &[FeatureSpec] = &[
    ...
    FeatureSpec {
        id: Feature::XedocGitCommit,
        key: "xedoc_git_commit",
        stage: Stage::Removed,
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            ...
            announcement: "NEW: Network proxy can now be enabled from /experimental. Restart Xedoc after enabling it.",
        },
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: if cfg!(any(
            ...
            Stage::Experimental {
                ...
                menu_description: "Keep your computer awake while Xedoc is running a thread.",
