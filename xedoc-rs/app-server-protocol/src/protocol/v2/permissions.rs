...
use std::path::Path;
use ts_rs::TS;
use xedoc_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use xedoc_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use xedoc_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use xedoc_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use xedoc_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use xedoc_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
use xedoc_protocol::models::LegacyReadWriteRoots;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> xedoc_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<xedoc_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: xedoc_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            xedoc_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            xedoc_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            xedoc_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
