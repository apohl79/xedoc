...
use serde::Serialize;
use ts_rs::TS;
use xedoc_protocol::protocol::HookEventName as CoreHookEventName;
use xedoc_protocol::protocol::HookExecutionMode as CoreHookExecutionMode;
use xedoc_protocol::protocol::HookHandlerType as CoreHookHandlerType;
use xedoc_protocol::protocol::HookOutputEntry as CoreHookOutputEntry;
use xedoc_protocol::protocol::HookOutputEntryKind as CoreHookOutputEntryKind;
use xedoc_protocol::protocol::HookRunStatus as CoreHookRunStatus;
use xedoc_protocol::protocol::HookRunSummary as CoreHookRunSummary;
use xedoc_protocol::protocol::HookScope as CoreHookScope;
use xedoc_protocol::protocol::HookSource as CoreHookSource;
use xedoc_protocol::protocol::HookTrustStatus as CoreHookTrustStatus;
