...
use xedoc_protocol::protocol::CreditsSnapshot as CoreCreditsSnapshot;
use xedoc_protocol::protocol::RateLimitReachedType as CoreRateLimitReachedType;
use xedoc_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use xedoc_protocol::protocol::RateLimitWindow as CoreRateLimitWindow;
use xedoc_protocol::protocol::SpendControlLimitSnapshot as CoreSpendControlLimitSnapshot;
    ...
    fn from(account: ProviderAccount) -> Self {
        match account {
            ...
            ProviderAccount::AmazonBedrock {
                uses_xedoc_managed_credentials,
            } => Self::AmazonBedrock {
                uses_xedoc_managed_credentials,
            },
        }
...
pub enum LoginAccountParams {
    ...
    /// The access token must contain the same scopes that Xedoc-managed ChatGPT auth tokens have.
    ...
    ChatgptAuthTokens {
        ...
        ///
        /// When `null`, Xedoc attempts to derive the plan type from access-token
...
pub enum ChatgptAuthTokensRefreshReason {
    /// Xedoc attempted a backend request and received `401 Unauthorized`.
    Unauthorized,
}
...
pub struct ChatgptAuthTokensRefreshParams {
    ...
    /// Workspace/account identifier that Xedoc was previously using.
    ///
