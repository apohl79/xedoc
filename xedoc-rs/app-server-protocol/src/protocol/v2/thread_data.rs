...
use xedoc_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use xedoc_protocol::protocol::ThreadHistoryMode as CoreThreadHistoryMode;
use xedoc_protocol::protocol::ThreadSource as CoreThreadSource;
...
#[ts(export_to = "v2/")]
pub struct Thread {
    /// Identifier for this thread. Xedoc-generated thread IDs are UUIDv7.
    pub id: String,
    ...
    /// Origin of the thread (CLI, VSCode, xedoc exec, xedoc app-server, etc.).
...
#[ts(export_to = "v2/")]
pub struct Turn {
    /// Identifier for this turn. Xedoc-generated turn IDs are UUIDv7.
    pub id: String,
