...
pub use xedoc_extension_items::image_generation::ImageGenerationItem;
pub use xedoc_extension_items::sleep::SleepItem;
pub use xedoc_extension_items::web_search::WebSearchAction;
pub use xedoc_extension_items::web_search::WebSearchItem;
use xedoc_protocol::items::AgentMessageContent as CoreAgentMessageContent;
...
use xedoc_protocol::parse_command::ParsedCommand as CoreParsedCommand;
...
pub(crate) fn web_search_action_from_core(
    value: xedoc_protocol::models::WebSearchAction,
) -> WebSearchAction {
    match value {
        xedoc_protocol::models::WebSearchAction::Search { query, queries } => {
            WebSearchAction::Search { query, queries }
        }
        xedoc_protocol::models::WebSearchAction::OpenPage { url } => {
            WebSearchAction::OpenPage { url }
        }
        xedoc_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
            WebSearchAction::FindInPage { url, pattern }
        }
        xedoc_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
    }
}
...
impl From<xedoc_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: xedoc_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<xedoc_protocol::dynamic_tools::DynamicToolCallOutputContentItem>
    for DynamicToolCallOutputContentItem
{
    fn from(item: xedoc_protocol::dynamic_tools::DynamicToolCallOutputContentItem) -> Self {
        match item {
...
impl From<DynamicToolCallOutputContentItem>
    for xedoc_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
