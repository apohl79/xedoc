...
use xedoc_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use xedoc_protocol::plan_tool::StepStatus as CorePlanStepStatus;
use xedoc_protocol::user_input::ByteRange as CoreByteRange;
use xedoc_protocol::user_input::TextElement as CoreTextElement;
...
pub struct TurnStartParams {
    ...
    /// Optional metadata to enrich Xedoc's ResponsesAPI turn metadata.
    ///
...
#[ts(export_to = "v2/")]
pub enum TurnSteerCancelStatus {
    Canceled,
    NotFound,
}
...
pub struct TurnSteerCancelResponse {
    pub status: TurnSteerCancelStatus,
}
