...
use xedoc_protocol::items::McpToolCallError as CoreMcpToolCallError;
use xedoc_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use xedoc_protocol::mcp::McpServerInfo;
use xedoc_protocol::mcp::Resource as McpResource;
pub use xedoc_protocol::mcp::ResourceContent as McpResourceContent;
use xedoc_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use xedoc_protocol::mcp::Tool as McpTool;

v2_enum_from_core!(
    pub enum McpAuthStatus from xedoc_protocol::protocol::McpAuthStatus {
        Unsupported,
        NotLoggedIn,
        BearerToken,
        OAuth
...
v2_enum_from_core!(
    pub enum McpServerStartupFailureReason from xedoc_protocol::protocol::McpStartupFailureReason {
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> xedoc_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => xedoc_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => xedoc_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => xedoc_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active Xedoc turn when this elicitation was observed, if app-server could correlate one.
    ///
