...
use ts_rs::TS;
use xedoc_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use xedoc_protocol::protocol::SkillInterface as CoreSkillInterface;
use xedoc_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use xedoc_protocol::protocol::SkillScope as CoreSkillScope;
use xedoc_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
