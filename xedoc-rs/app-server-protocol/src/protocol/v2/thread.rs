...
pub use xedoc_protocol::capabilities::CapabilityRootLocation;
pub use xedoc_protocol::capabilities::SelectedCapabilityRoot;
...
use xedoc_protocol::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use xedoc_protocol::protocol::TokenUsage as CoreTokenUsage;
use xedoc_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
pub struct ThreadStartParams {
    ...
    #[serde(
        default,
        deserialize_with = "xedoc_protocol::dynamic_tools::deserialize_dynamic_tool_specs"
    )]
    #[ts(optional = nullable)]
    ...
    /// This is for internal use only (e.g. Xedoc Cloud).
...
pub struct ThreadResumeParams {
    ...
    /// [UNSTABLE] FOR XEDOC CLOUD - DO NOT USE.
...
impl From<xedoc_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: xedoc_protocol::protocol::ThreadGoal) -> Self {
        Self {
