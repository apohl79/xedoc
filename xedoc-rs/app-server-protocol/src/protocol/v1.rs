...
pub use xedoc_protocol::protocol::GitSha;
...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [xedoc_protocol::protocol::PatchApplyBeginEvent]
    /// and [xedoc_protocol::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [xedoc_protocol::protocol::ExecCommandBeginEvent]
    /// and [xedoc_protocol::protocol::ExecCommandEndEvent].
    pub call_id: String,
