...
mod tests {
    ...
    use xedoc_login::save_auth;
    use xedoc_login::token_data::TokenData;
    use xedoc_protocol::auth::AuthMode;
    ...
    fn write_chatgpt_auth(xedoc_home: &Path, plan_type: &str) {
        ...
        let auth = AuthDotJson {
            ...
            tokens: Some(TokenData {
                id_token: xedoc_login::token_data::parse_chatgpt_jwt_claims(&id_token)
    ...
    fn loads_local_chatgpt_auth_from_managed_auth() {
        let xedoc_home = TempDir::new().expect("tempdir");
        write_chatgpt_auth(xedoc_home.path(), "business");
    ...
    fn preserves_usage_based_plan_type_wire_name() {
        let xedoc_home = TempDir::new().expect("tempdir");
        write_chatgpt_auth(xedoc_home.path(), "self_serve_business_usage_based");
