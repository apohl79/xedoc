...
use xedoc_tui_session_picker::SessionPickerEvent;
use xedoc_tui_session_picker::SessionPickerTui;

use crate::custom_terminal;
use crate::tui::Tui;
use crate::tui::TuiEvent;

pub(crate) use xedoc_tui_session_picker::SessionSelection;
pub(crate) use xedoc_tui_session_picker::SessionTarget;
pub(crate) use xedoc_tui_session_picker::resume_source_kinds;
pub(crate) use xedoc_tui_session_picker::run_fork_picker_with_app_server;
pub(crate) use xedoc_tui_session_picker::run_resume_picker_from_existing_session_with_app_server;
pub(crate) use xedoc_tui_session_picker::run_resume_picker_with_app_server;
...
impl SessionPickerTui for Tui {
    ...
    fn frame_requester(&self) -> xedoc_tui_frame::FrameRequester {
