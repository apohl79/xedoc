...
pub(crate) const TARGET_FRAME_INTERVAL: Duration = xedoc_tui_frame::MIN_FRAME_INTERVAL;
...
/// Restore the terminal after Xedoc is exiting.
///
...
impl Tui {
    pub(crate) fn new(
        ...
        let is_zellij = xedoc_terminal_detection::terminal_info().is_zellij();
    ...
    /// terminal modes and stderr (optionally keeping raw mode enabled), then re-applies Xedoc TUI
