...
//!
//! This module owns fire-and-forget fetch/write helpers for MCP inventory, skills, and plugins.
//! Results are routed back through `AppEvent` so the main event loop remains single-threaded.
    ...
    request_handle
        .request_typed(ClientRequest::ConfigBatchWrite {
            ...
            params: ConfigBatchWriteParams {
                edits: vec![xedoc_app_server_protocol::ConfigEdit {
...
pub(super) type McpInventoryMaps = (
    HashMap<String, xedoc_protocol::mcp::Tool>,
    HashMap<String, Vec<xedoc_protocol::mcp::Resource>>,
    HashMap<String, Vec<xedoc_protocol::mcp::ResourceTemplate>>,
    ...
    for status in statuses {
        ...
        auth_statuses.insert(
            ...
            match status.auth_status {
                xedoc_app_server_protocol::McpAuthStatus::Unsupported => McpAuthStatus::Unsupported,
                xedoc_app_server_protocol::McpAuthStatus::NotLoggedIn => McpAuthStatus::NotLoggedIn,
                xedoc_app_server_protocol::McpAuthStatus::BearerToken => McpAuthStatus::BearerToken,
                xedoc_app_server_protocol::McpAuthStatus::OAuth => McpAuthStatus::OAuth,
            },
        );
