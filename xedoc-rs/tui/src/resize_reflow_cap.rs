...
//! the fallback bucket.
//!
//! These caps are deliberately conservative: Xedoc is rebuilding normal terminal scrollback, not an
...
use xedoc_config::types::DEFAULT_TERMINAL_RESIZE_REFLOW_FALLBACK_MAX_ROWS;
