...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct FooterKeyHints {
    pub toggle_shortcuts: Option<KeyBinding>,
    pub queue: Option<KeyBinding>,
    pub insert_newline: Option<KeyBinding>,
    pub external_editor: Option<KeyBinding>,
    pub edit_previous: Option<KeyBinding>,
    pub show_transcript: Option<KeyBinding>,
    pub history_search: Option<KeyBinding>,
    pub reasoning_down: Option<KeyBinding>,
    pub reasoning_up: Option<KeyBinding>,
}
...
pub fn goal_status_indicator_line(
...
pub fn status_line_right_indicator_line(
    collaboration_mode_indicator: Option<CollaborationModeIndicator>,
...
pub fn side_conversation_context_line(label: &str) -> Line<'static> {
...
pub fn configured_status_line(props: &FooterProps) -> Option<Line<'static>> {
...
pub fn active_agent_context_line(active_agent_label: Option<&str>) -> Option<Line<'static>> {
...
pub fn with_active_agent_context_line(
