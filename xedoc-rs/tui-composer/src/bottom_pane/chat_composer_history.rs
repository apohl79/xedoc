...
impl HistoryEntry {
    ...
    pub fn new_with_at_mentions(text: String, at_mentions_enabled: bool) -> Self {
...
mod tests {
    ...
    fn search_matches_local_history_and_stops_at_boundaries() {
        ...
        history.record_local_submission(HistoryEntry::new("cargo test -p xedoc-tui".to_string()));
