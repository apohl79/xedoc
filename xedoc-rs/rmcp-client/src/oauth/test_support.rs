...
/// Serializes tests that mutate process-wide XEDOC_HOME.
///
...
pub(super) struct TempXedocHome {
...
impl TempXedocHome {
    pub(super) fn new() -> Self {
        ...
        let dir = tempdir().expect("create XEDOC_HOME temp dir");
        unsafe {
            std::env::set_var("XEDOC_HOME", dir.path());
        }
        Self {
            _guard: guard,
            _dir: dir,
