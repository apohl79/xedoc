...
use crate::oauth::test_support::TempXedocHome;
use xedoc_config::types::OAuthCredentialsStoreMode;

const STORE_LOCK_CONTENTION_EVENT_TARGET: &str = "xedoc_rmcp_client::oauth::store_lock::contention";
...
const LOCK_HOLDER_READY_PATH_ENV: &str = "XEDOC_OAUTH_STORE_LOCK_CHILD_READY_PATH";
    ...
    T: Send + 'static,
{
    std::thread::scope(|scope| {
        let held_lock =
            OAuthStoreLock::acquire_in(xedoc_home, store, Duration::from_millis(/*millis*/ 100))?;
