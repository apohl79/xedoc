...
const RESOURCE_URI: &str = "memo://xedoc/example-note";

fn stdio_server_bin() -> Result<PathBuf, CargoBinError> {
    xedoc_utils_cargo_bin::cargo_bin("test_stdio_server")
}
...
fn init_params() -> InitializeRequestParams {
    ...
    InitializeRequestParams::new(
        capabilities,
        Implementation::new("xedoc-test", "0.0.0-test").with_title("Xedoc rmcp resource test"),
    )
