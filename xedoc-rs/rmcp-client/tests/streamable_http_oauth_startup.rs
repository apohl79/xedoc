...
use xedoc_rmcp_client::StoredOAuthTokens;
use xedoc_rmcp_client::WrappedOAuthTokenResponse;
use xedoc_rmcp_client::determine_streamable_http_auth_status;
use xedoc_rmcp_client::is_authentication_required_error;
use xedoc_rmcp_client::save_oauth_tokens;
...
async fn refreshes_expired_persisted_token_before_initialize() -> anyhow::Result<()> {
    ...
    // Credential storage resolves XEDOC_HOME from the process environment.
