...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct ContextWindowGuidance {
    message: String,
}
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct TokenBudgetRemainingContext {
    tokens_left: Option<i64>,
}

impl TokenBudgetRemainingContext {
    pub fn new(tokens_left: i64) -> Self {
        Self {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct TokenBudgetReminder {
    message: String,
}

impl TokenBudgetReminder {
    pub fn new(message_template: &str, n_remaining: i64) -> Self {
        Self {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct AutoCompactFallbackPrompt {
    message: String,
}
