use xedoc_core_skills::AvailableSkills;
use xedoc_core_skills::SKILLS_HOW_TO_USE_WITH_ABSOLUTE_PATHS;
use xedoc_core_skills::SKILLS_HOW_TO_USE_WITH_ALIASES;
use xedoc_core_skills::render_available_skills_body;
use xedoc_protocol::protocol::SKILLS_INSTRUCTIONS_CLOSE_TAG;
use xedoc_protocol::protocol::SKILLS_INSTRUCTIONS_OPEN_TAG;

use super::ContextualUserFragment;

/// Model-context fragment describing the skills available to Xedoc.
