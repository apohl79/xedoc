...
//! which thread becomes active or when a thread closes, stays in the parent TUI orchestration.
...
use xedoc_app_server_protocol::CollabAgentState;
...
use xedoc_tui_render::render::line_utils::prefix_lines;
use xedoc_tui_transcript::history_cell::PlainHistoryCell;
use xedoc_tui_transcript::text_formatting::truncate_text;
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SubAgentActivityDisplay {
    pub thread_id: ThreadId,
    pub agent_path: String,
    pub model_provider_id: Option<String>,
    pub model: Option<String>,
    pub reasoning_effort: Option<ReasoningEffortConfig>,
    pub running_state_update: AgentRunningStateUpdate,
    pub current_activity: Option<String>,
}
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum AgentRunningStateUpdate {
    SetRunning,
    SetIdle,
    Preserve,
}
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SpawnRequestSummary {
    pub model: String,
    pub reasoning_effort: ReasoningEffortConfig,
}

pub fn agent_picker_status_dot_spans(is_closed: bool) -> Vec<Span<'static>> {
...
pub fn previous_agent_shortcut() -> xedoc_tui_input::key_hint::KeyBinding {
    xedoc_tui_input::key_hint::alt(KeyCode::Left)
}

pub fn next_agent_shortcut() -> xedoc_tui_input::key_hint::KeyBinding {
    xedoc_tui_input::key_hint::alt(KeyCode::Right)
}
...
pub fn previous_agent_shortcut_matches(
    key_event: KeyEvent,
...
/// navigation working when enhanced key reporting is unavailable.
pub fn next_agent_shortcut_matches(key_event: KeyEvent, allow_word_motion_fallback: bool) -> bool {
...
pub fn spawn_request_summary(item: &ThreadItem) -> Option<SpawnRequestSummary> {
    match item {
...
pub fn sub_agent_activity_display(item: &ThreadItem) -> Option<SubAgentActivityDisplay> {
