...
use xedoc_protocol::config_types::WebSearchFilters;
use xedoc_protocol::config_types::WebSearchUserLocation;
use xedoc_protocol::config_types::WebSearchUserLocationType;
use xedoc_tools::ResponsesApiWebSearchFilters;
use xedoc_tools::ResponsesApiWebSearchUserLocation;
