...
impl HistoryCell for UpdateAvailableHistoryCell {
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        let update_instruction = if let Some(update_action) = self.update_action {
            ...
            line![
                "See ",
                "https://github.com/apohl79/codex".cl_cyan().underlined(),
        ...
        let content = text![
            line![
                ...
                " ",
                format!("{} -> {}", xedoc_cli_version(), self.latest_version).bold(),
            ],
            update_instruction,
            "",
            "See full release notes:",
            "https://github.com/apohl79/codex/releases/latest"
                .cl_cyan()
                .underlined(),
        ];
    ...
    fn raw_lines(&self) -> Vec<Line<'static>> {
        let update_instruction = if let Some(update_action) = self.update_action {
            ...
            "See https://github.com/apohl79/codex for installation options.".to_string()
        };
        vec![
            ...
            Line::from("https://github.com/apohl79/codex/releases/latest"),
        ]
    }
