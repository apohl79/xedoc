...
use xedoc_app_server_protocol::HookOutputEntry;
use xedoc_app_server_protocol::HookOutputEntryKind;
use xedoc_app_server_protocol::HookRunStatus;
use xedoc_app_server_protocol::HookRunSummary;
...
pub fn new_completed_hook_cell(
    run: HookRunSummary,
    animations_enabled: bool,
    show_output: bool,
) -> HookCell {
    ...
    fn completed_hook_short_multiline_context_preserves_display_transcript_and_raw_lines() {
        let cell = completed_hook_cell(
            ...
            vec![HookOutputEntry {
                ...
                text: "## Working Memory Recall\n\nSource: Xedoc compaction".to_string(),
            }],
        );
        let expected = vec![
