...
impl HistoryCell for UserHistoryCell {
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        let element_style = style.fg(Color::Rgb(0, 139, 148));
...
impl AgentMessageCell {
    ...
    pub fn new_hyperlink_lines(lines: Vec<HyperlinkLine>, is_first_line: bool) -> Self {
        Self {
            lines,
            is_first_line,
        }
...
impl StreamingAgentTailCell {
    pub fn new(lines: Vec<HyperlinkLine>, is_first_line: bool) -> Self {
        Self {
            lines,
            is_first_line,
        }
...
pub fn split_reasoning_summary_parts(reasoning_parts: &[String]) -> (String, String) {
