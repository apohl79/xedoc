...
#[cfg(any(not(debug_assertions), test))]
use xedoc_install_context::StandalonePlatform;
...
pub enum UpdateAction {
    ...
    PnpmGlobalLatest,
    /// Update via `brew upgrade xedoc`.
    BrewUpgrade,
    /// Update via `curl -fsSL https://chatgpt.com/codex/install.sh | XEDOC_NON_INTERACTIVE=1 sh`.
    StandaloneUnix,
    /// Update via `$env:XEDOC_NON_INTERACTIVE=1; irm https://chatgpt.com/codex/install.ps1 | iex`.
    StandaloneWindows,
...
impl UpdateAction {
    ...
    pub fn command_args(self) -> (&'static str, &'static [&'static str]) {
        match self {
            ...
            UpdateAction::StandaloneUnix => (
                ...
                &[
                    "-c",
                    "curl -fsSL https://chatgpt.com/codex/install.sh | XEDOC_NON_INTERACTIVE=1 sh",
                ],
            ),
            UpdateAction::StandaloneWindows => (
                ...
                &[
                    ...
                    "Bypass",
                    "-c",
                    "$env:XEDOC_NON_INTERACTIVE=1; irm https://chatgpt.com/codex/install.ps1 | iex",
                ],
            ),
            #[cfg(target_os = "macos")]
    ...
    /// Returns whether Xedoc must relaunch after this update completes.
...
pub fn get_update_action() -> Option<UpdateAction> {
    #[cfg(target_os = "macos")]
    if crate::update_versions::is_apohl79_fork_release(crate::version::xedoc_cli_version()) {
        ...
        assert_eq!(
            UpdateAction::from_install_context(&InstallContext {
                method: InstallMethod::Standalone {
                    ...
                    resources_dir: Some(native_release_dir.join("xedoc-resources")),
                },
                package_layout: None,
            }),
