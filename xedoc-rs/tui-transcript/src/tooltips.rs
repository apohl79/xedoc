...
pub mod announcement {
    ...
    impl TargetOs {
        const fn current() -> Self {
            if cfg!(target_os = "macos") {
                ...
                // Xedoc currently publishes CLI builds for macOS, Windows, and Linux.
                Self::Linux
            }
        }
    }
    ...
    pub fn parse_announcement_tip_toml(text: &str, plan: Option<PlanType>) -> Option<String> {
        ...
        for raw in announcements {
            ...
            if tip.version_matches(xedoc_cli_version())
...
from_date = "2000-01-01"
    ...
    fn announcement_tip_toml_parse_comments() {
        let toml = r#"
# Example announcement tips for Xedoc TUI.
...
[[announcements]]
content = "Welcome to Xedoc! Check out the new onboarding flow."
